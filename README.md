...
### Made with vanilla JS (Alpine.js for reactivity, no build step/framework).

## Live preview

- ## Live site: https://cortisol-sales.netlify.app/
- ## Source (HTML/CSS/JS): https://github.com/milic12/cortisol-demo
...
1. **No JS at all, page was fully static/non-interactive.**

2. **Broken JS, image slider didn't work at all.**

3. **Responsiveness was broken.**

4. **The same Google Fonts stylesheet was linked many times.**

5. **Typos across the page**
